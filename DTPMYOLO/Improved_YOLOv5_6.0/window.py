...
"""
-------------------------------------------------
Project Name: Real-time pedestrian mask-wearing detection and tracking using improved YOLOv5 and DeepSORT
...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        # 初始化界面
        super().__init__()
        self.setWindowTitle('Real-time pedestrian mask-wearing detection and tracking using improved YOLOv5 and DeepSORT')
        ...
        self.model = self.model_load(weights="runs/train/exp17/weights/best.pt",
    ...
    ***界面初始化***
    ...
    def initUI(self):
        # 图片检测子界面
        font_title = QFont('Times New Roman', 20)
        font_main = QFont('Times New Roman', 20)
        ...
        self.webcam_detection_btn = QPushButton("Real-time Camera Tracking")
        ...
        about_title = QLabel('\n\n Real-time pedestrian mask-wearing detection and tracking')  # todo 欢迎词语
        about_title.setFont(QFont('Times New Roman', 18))
        about_title.setAlignment(Qt.AlignCenter)

        about_title_Name = QLabel('\n [ Wang Shuai ]')  # todo 欢迎词语
        about_title_Name.setFont(QFont('Times New Roman', 18))
        about_title_Name.setAlignment(Qt.AlignCenter)
        about_title_Name.setStyleSheet("QLabel{background:white;}"
                                  "QLabel{color:rgb(125,20,20,200);font-size:28px;font-weight:bold;font-family:Times New Roman;}"
                                  "QLabel:hover{color:rgb(100,100,100,120);}")

        about_title_major = QLabel('\n PhD in Computer Science-1002268166')  # todo 欢迎词语
        about_title_major.setFont(QFont('Times New Roman', 18))
        about_title_major.setAlignment(Qt.AlignCenter)

        about_img = QLabel()
        about_img.setPixmap(QPixmap('images/UI/icsdi.jpg'))
        about_img.setAlignment(Qt.AlignCenter)

        # label4.setText("<a href='https://oi.wiki/wiki/学习率的调整'>如何调整学习率</a>")
        label_super = QLabel()  # todo 作者
        label_super.setText("<a href='https://www.ucsiuniversity.edu.my/about-us/Institute-of-Computer-Science-and-Digital-Innovation'>ICSDS of UCSI University</a>")
        label_super.setFont(QFont('Times New Roman', 16))
        label_super.setOpenExternalLinks(True)
        # label_super.setOpenExternalLinks(True)
        label_super.setAlignment(Qt.AlignRight)
        about_layout.addWidget(about_title)
        about_layout.addWidget(about_title_Name)
        about_layout.addWidget(about_title_major)
        ...
        self.addTab(about_widget, 'About us')
    ...
    ***检测图片***
    ...
    def detect_img(self):
        ...
        print(source)
        if source == "":
            QMessageBox.warning(self, "Please upload", "Please upload the image first before running the detection")
        else:
            source = str(source)
                    ...
                    if len(det):
                        ...
                        for *xyxy, conf, cls in reversed(det):
                            ...
                            if save_img or save_crop or view_img:  # Add bbox to image
                                ...
                                label = None if hide_labels else (names[c] if c == 1 else f'{names[c]} {conf:.2f}')
    ...
    def reset_vid(self):
        self.webcam_detection_btn.setEnabled(True)
        self.mp4_detection_btn.setEnabled(True)
        self.vid_img.setPixmap(QPixmap("images/UI/icsdi.jpg"))
        self.vid_source = '0'
        self.webcam = True
